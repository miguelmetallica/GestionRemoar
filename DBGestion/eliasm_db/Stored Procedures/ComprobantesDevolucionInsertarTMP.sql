CREATE PROCEDURE [eliasm_db].[ComprobantesDevolucionInsertarTMP]	
	@Id nvarchar(150),
...
BEGIN TRY
	...
	BEGIN
		BEGIN TRAN	
			...
			SELECT D.Id,D.ComprobanteId,D.ProductoId,D.ProductoCodigo,D.ProductoNombre,
				D.Cantidad,D.UnidadMedidaId,D.UnidadMedidaCodigo,D.UnidadMedida,
			...
			FROM ComprobantesDetalle D --ON I.DetalleId = D.Id
			WHERE D.Id = @Id
