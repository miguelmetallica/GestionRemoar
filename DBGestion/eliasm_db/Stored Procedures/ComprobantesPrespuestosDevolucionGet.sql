CREATE PROCEDURE [eliasm_db].[ComprobantesPrespuestosDevolucionGet]
AS
BEGIN
	SELECT 
		P.Id,
	...
	AND P.Estado = 1
	AND EXISTS (SELECT 1 FROM ComprobantesDetalleImputacion P1 WHERE P1.RemitoId = P.Id AND P1.DevolucionId is null)	
