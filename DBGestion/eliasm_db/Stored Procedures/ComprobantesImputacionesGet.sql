CREATE PROCEDURE [eliasm_db].[ComprobantesImputacionesGet]
AS
BEGIN
	SELECT 
		P.Id,
	...
	SELECT 
		...
		P.UsuarioAlta,
		0 Saldo,
		100 Saldo_Porcentaje,
		R.Codigo CodigoPresupuesto
		FROM Comprobantes P	
		INNER JOIN VentasRapidas R on R.ComprobanteId = p.Id
		WHERE P.Codigo IS NOT NULL	
		AND P.Estado = 1
