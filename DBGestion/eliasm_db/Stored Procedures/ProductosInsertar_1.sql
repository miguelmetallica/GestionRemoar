CREATE PROCEDURE [eliasm_db].[ProductosInsertar]
	@Id nvarchar(150),
...
BEGIN TRY
	...
	BEGIN TRAN
			...
			INSERT INTO Productos(Id,TipoProductoId,Codigo,Producto,
								...
								AceptaDescuento,PrecioRebaja,
								RebajaDesde,RebajaHasta,
								ControlaStock,Estado,FechaAlta,UsuarioAlta)
						VALUES(@Id,@TipoProductoId,UPPER(@Codigo),UPPER(@Producto),
								...
								@AceptaDescuento,@PrecioRebaja,
								@RebajaDesde,@RebajaHasta,
								@ControlaStock,@Estado,DATEADD(HH,4,GETDATE()),UPPER(@Usuario))		
