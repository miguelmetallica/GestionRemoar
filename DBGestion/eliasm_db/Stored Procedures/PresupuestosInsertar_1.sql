CREATE PROCEDURE [eliasm_db].[PresupuestosInsertar]
	@Id nvarchar(150),
...
BEGIN TRY
	...
	BEGIN TRAN
		...
		INSERT INTO Presupuestos(Id,Codigo,Fecha,
							...
							EstadoId,DescuentoId,DescuentoPorcentaje,SucursalId,
							Estado,FechaAlta,UsuarioAlta)
					VALUES(@Id,UPPER(@Codigo),
							DATEADD(HH,4,GETDATE()),DATEADD(DD,@Validez,DATEADD(HH,4,GETDATE())),
							@ClienteId,@TipoResponsableId,@CategoriaId,@EstadoId,NULL,0,@Sucursal,
