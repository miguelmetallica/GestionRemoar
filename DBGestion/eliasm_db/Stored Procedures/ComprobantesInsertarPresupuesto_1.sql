CREATE PROCEDURE [eliasm_db].[ComprobantesInsertarPresupuesto]	
...
BEGIN TRY
	...
	inner join presupuestos P on P.Id = d.presupuestoId
	...
	BEGIN TRAN		
			...
			SELECT NEWID() Id,
				...
				D.Precio PrecioLista,
				D.PrecioSinImpuesto PrecioSinIvaLista,
				D.Precio * D.Cantidad SubTotalLista,
				D.PrecioSinImpuesto * D.Cantidad SubTotalSinIvaLista,
