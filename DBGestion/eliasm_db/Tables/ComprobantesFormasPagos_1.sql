CREATE TABLE [eliasm_db].[ComprobantesFormasPagos] (
    ...
    CONSTRAINT [FK_ComprobantesFormasPagos_Comprobantes] FOREIGN KEY ([ComprobanteId]) REFERENCES [eliasm_db].[Comprobantes] ([Id]),
    CONSTRAINT [FK_ComprobantesFormasPagos_FormasPagos] FOREIGN KEY ([FormaPagoId]) REFERENCES [eliasm_db].[FormasPagos] ([Id]),
    CONSTRAINT [FK_ComprobantesFormasPagos_ParamBancos] FOREIGN KEY ([ChequeBancoId]) REFERENCES [eliasm_db].[ParamEntidades] ([Id])
);
