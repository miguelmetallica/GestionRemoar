CREATE TABLE [eliasm_db].[Comprobantes] (
    ...
    CONSTRAINT [FK_Comprobantes_Clientes] FOREIGN KEY ([ClienteId]) REFERENCES [eliasm_db].[Clientes] ([Id]),
    CONSTRAINT [FK_Comprobantes_ParamConceptosIncluidos] FOREIGN KEY ([ConceptoIncluidoId]) REFERENCES [eliasm_db].[ParamConceptosIncluidos] ([Id]),
    CONSTRAINT [FK_Comprobantes_ParamProvincias] FOREIGN KEY ([ProvinciaId]) REFERENCES [eliasm_db].[ParamProvincias] ([Id]),
    CONSTRAINT [FK_Comprobantes_ParamTiposComprobantes] FOREIGN KEY ([TipoComprobanteId]) REFERENCES [eliasm_db].[ParamTiposComprobantes] ([Id]),
    CONSTRAINT [FK_Comprobantes_ParamTiposComprobantes1] FOREIGN KEY ([TipoComprobanteAnulaId]) REFERENCES [eliasm_db].[ParamTiposComprobantes] ([Id]),
    CONSTRAINT [FK_Comprobantes_ParamTiposDocumentos] FOREIGN KEY ([TipoDocumentoId]) REFERENCES [eliasm_db].[ParamTiposDocumentos] ([Id]),
    CONSTRAINT [FK_Comprobantes_ParamTiposResponsables] FOREIGN KEY ([TipoResponsableId]) REFERENCES [eliasm_db].[ParamTiposResponsables] ([Id]),
    CONSTRAINT [FK_Comprobantes_Presupuestos] FOREIGN KEY ([PresupuestoId]) REFERENCES [eliasm_db].[Presupuestos] ([Id])
);
