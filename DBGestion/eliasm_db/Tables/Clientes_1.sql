CREATE TABLE [eliasm_db].[Clientes] (
    ...
    CONSTRAINT [FK_Clientes_ParamProvincias] FOREIGN KEY ([ProvinciaId]) REFERENCES [eliasm_db].[ParamProvincias] ([Id]),
    CONSTRAINT [FK_Clientes_ParamTiposDocumentos] FOREIGN KEY ([TipoDocumentoId]) REFERENCES [eliasm_db].[ParamTiposDocumentos] ([Id])
);


GO
CREATE UNIQUE NONCLUSTERED INDEX [IX_Clientes_Tipo_Nro_Documento]
    ON [eliasm_db].[Clientes]([TipoDocumentoId] ASC, [NroDocumento] ASC);
